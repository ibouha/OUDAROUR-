...
export const invoiceItems = pgTable("invoice_items", {
  ...
  productReference: text("product_reference"), productName: text("product_name").notNull(), description: text("description"), quantity: numeric("quantity", { precision: 12, scale: 3 }).notNull(), unit: text("unit"),
